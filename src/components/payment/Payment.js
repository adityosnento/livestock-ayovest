...
const FormPayments = (props) => {
  return (
    ...
    <FormGroup>
        ...
        <Input type="text" name="address" id="exampleAddress" placeholder="Transfer Bank"/>
      </FormGroup>
      <FormGroup>
        <Label for="exampleAddress">Card Number</Label>
        <Input type="text" name="address" id="exampleAddress" placeholder="0000 0000 0000 0000"/>
      </FormGroup>
      <FormGroup>
        <Label for="exampleAddress">Name on Card</Label>
        <Input type="text" name="address" id="exampleAddress" placeholder="Bayu Lestiawan"/>
      </FormGroup>
      <Row form>
        <Col md={6}>
          <FormGroup>
            <Label for="exampleCardExpired">Expired Date</Label>
            <Input type="text" name="text" id="exampleCardExpired" placeholder="MM/YY" />
          </FormGroup>
        </Col>
        <Col md={6}>
          <FormGroup>
            <Label for="exampleCVC">CVC</Label>
            <Input type="text" name="text" id="exampleCVC" placeholder="123" />
          </FormGroup>
        </Col>
      </Row>
